      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9f9f9;">
          <div style="background: linear-gradient(90deg, #a78bfa, #60a5fa); padding: 2px; border-radius: 10px;">
            <div style="background: #ffffff; border-radius: 8px; padding: 30px;">
              ...
              <div style="background: #f3f4f6; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                ...
                <p style="margin: 4px 0 0; color: #a78bfa; font-size: 14px;">
                  ${email}
                </p>
              </div>
              ...
              <a
                href="mailto:${email}"
                style="background: linear-gradient(90deg, #a78bfa, #60a5fa); color: #ffffff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;"
              >
                Reply to ${name} ↗
              </a>
          ...
          <p style="color: #9ca3af; font-size: 12px; text-align: center; margin-top: 16px;">
            Sent from Deepak Kumar's portfolio contact form
          </p>
        </div>
      `,
    });
